  ...
  return (
    <div className="w-full max-w-md rounded-lg bg-gray-800 p-8 text-white shadow-xl">
      ...
      <Link
        ...
        className="block w-full rounded-lg bg-blue-600 p-5 text-center text-xl font-bold shadow-lg transition hover:bg-blue-500"
      >
        + Create New Game
      </Link>
      ...
      <form onSubmit={handleJoinGame}>
        ...
        <button
          ...
          className="mt-4 w-full rounded-lg bg-green-600 p-4 text-lg font-bold shadow-lg transition hover:bg-green-500 disabled:opacity-50"
        >
          Join Game
        </button>
      </form>
